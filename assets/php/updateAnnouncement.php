...
$_SESSION['updateAnnouncementId'] = $_GET['id'];
...
<h1><a href="../php/home.php">E-Learning</a></h1>
 ...
 <section class="insert-announcement-page">
              ...
              <h3 class="title">Update announcement</h3>
              <form class="contact-form-container" action="../php/announcements.php" method="POST">
              
                    <div class="form-attribute form-fname"> 
                        <input class="form-input" type="date" id="fname" name="date" value="<?php  echo $_GET['date'];?>" required>
                    </div>
                 
                     <div class="form-attribute form-lname"> 
                         <input class="form-input" type="text" id="lname" name="topic" value="<?php  echo $_GET['topic'];?>" required>
                     </div>
                 ...
                 <div class="form-attribute form-subject">
                    <textarea rows="5" class="form-input-subject" id="subject" name="mainContent" value="<?php  echo $_GET['mainContent'];?>"  style="height:200px" required></textarea></div>
                    
               <div class="form-submit"> 
                   <input class="input-submit" type="submit"  value="Post" name="updateAnnouncement" >
                </div>
