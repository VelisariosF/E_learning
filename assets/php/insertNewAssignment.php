    ...
    <section class="insert-announcement-page">
        ...
        <form class="contact-form-container" action="assignments.php" method="POST">
            ...
            <div class="form-attribute form-lname">
                <input class="form-input" type="text" id="lname" name="homeworkToDeliver" placeholder="Deliverables..">
            </div> 
            

            <div class="form-attribute form-lname">
                <input class="form-input" type="text" id="lname" name="path" placeholder="path or name of file..">
            </div>

         
            <div class="form-attribute form-lname">
                <input class="form-input" type="date" id="lname" name="deliveryDate" placeholder="Delivery date..">
            </div>

            <div class="form-submit">
                <input class="input-submit" type="submit" value="Post" name="insertNewHomework">
            </div>
